...
# add "Best Student Paper" to Dedy's ITNAC2025 paper
sed -i '' 's+\[&nbsp;<a href="publication-conf_bib.html#hendro2025investigation"+ <b style="color:red;">(Best Student Paper Award)</b> &nbsp;<a href="publication-conf_bib.html#hendro2025investigation"+g' publication-conf.html
